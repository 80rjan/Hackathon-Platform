...
import userData from "../userDetails/UserDetails.json"
...
const HackathonsInfo = () => {
    ...
    const totalHackathons = currentUser.completedHackathons.length;
    const wonHackathons = currentUser?.completedHackathons.filter(hackathon => hackathon.won).length || 0;
    const percentageWonHackathons = (wonHackathons / totalHackathons) * 100;
    ...
    return (
        <div className="hackathonInfoContainer">
            <div className="firstRow">
                <h3 className="hackathonHeading">Completed Hackathons</h3>
                {currentUser && (
                    <div className="hackathons">
                        {currentUser.completedHackathons.map(hackathon => (
                            <div key={hackathon} className="hackathon">
                                {hackathon.won ? <img src={goldMedal}/> : silverMedalSvg}
                                <p>{hackathon.name}</p>
                            </div>
                        ))}
                    </div>
            ...
            <div className="secondRow">
                <div className="container won">
                    <h3>Won</h3>
                    <CircularProgressBar progress={percentageWonHackathons} index={3} size={100}/>
                </div>
                ...
                <div className="container myDescription">
                    ...
                    <div className="details">{currentUser.description}</div>
                </div>
            </div>
            <Navbar></Navbar>
        </div>
